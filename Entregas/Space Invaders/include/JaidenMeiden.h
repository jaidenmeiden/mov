...
#ifndef CSS_JAIDENMEIDEN
#define CSS_JAIDENMEIDEN
...
} CSS_JAIDENMEIDEN_STATE;	///Generic character possible states that can be any character by default
...
} CSS_JAIDENMEIDEN_TRANSITIONS;	///Generic character possible states that can be any character by default
...
public:
    ...
    void AI_Death		();
    bool OutEvent		(CSS_JAIDENMEIDEN_TRANSITIONS EventName);
...
void *CSS_FSM_Dying		(LPSTR *args, CJaidenMeiden *JaidenMeiden);
